 ...
 */
final class Version20181128131001 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE education_content (id INT AUTO_INCREMENT NOT NULL, image LONGTEXT NOT NULL, position LONGTEXT NOT NULL, title LONGTEXT NOT NULL, text LONGTEXT NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
