 ...
 */
final class Version20181128142451 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bridges_top ADD text LONGTEXT NOT NULL, DROP text_top, DROP text_bottom');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bridges_top ADD text_bottom LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE text text_top LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
